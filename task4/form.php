...
<body>
    ...
    <form action="./index.php" method="POST" id="form">
        ...
        <label>
            Телефон:
            <input name="field-tel" placeholder="79121231212" type="tel" <?php if ($errors['field-tel']) {
                print 'class="error"';
            } ?> value="<?php print $values['field-tel']; ?>">
        </label><br>
        <label>
            Email:<br>
            <input name="field-email" placeholder="ex@ex.com" type="email" <?php if ($errors['field-email']) {
                print 'class="error"';
            } ?> value="<?php print $values['field-email']; ?>">
        </label><br>
        <label>
            Дата рождения:<br>
            <input name="field-date" value="2000-01-01" type="date" <?php if ($errors['field-date']) {
                print 'class="error"';
